...
public class Dal {
   ...
   //conection -> e um recurso da blibioteca java.sql.* usado para conexao ao banco de dados
    ...
    public static Connection conector(){
        ...
        //String url = "jdbc:mysql://localhost:3306/dbvictorh"; //local na maquina sem estar no servidor web
        String url = "jdbc:mysql://192.168.0.28:3306/dbvictorh";
